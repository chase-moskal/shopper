...
export function makeUseObjectForView({ stateMap, setupMap, render, getRenderCount, pullStateIndex, pullSetupIndex, }) {
    ...
    return {
        state(initial) {
            ...
            const setter = createStateSetter({
                stateMap,
                stateIndex,
                rerender,
            });
...
//# sourceMappingURL=make-use-object-for-view.js.map