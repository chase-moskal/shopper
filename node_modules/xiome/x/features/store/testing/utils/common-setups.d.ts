...
export declare function connectedStore(): Promise<{
    api: {
        circuit: {
            ...
            stripeWebhooks: {
                "account.updated": (event: import("stripe").Stripe.Event) => Promise<any>;
                "customer.subscription.updated": (event: import("stripe").Stripe.Event) => Promise<any>;
                "invoice.paid": (event: import("stripe").Stripe.Event) => Promise<any>;
            };
        ...
        client: (privileges: string[]) => Promise<{
            browserTab: () => Promise<{
                store: {
...
export declare function storeWithSubscriptionPlans(): Promise<{
    api: {
        circuit: {
            stripe: import("stripe").Stripe;
            stripeLiaison: {
    ...
    getMySubscription: (store: ReturnType<typeof makeStoreModel>, tierId: string) => import("../../isomorphic/concepts.js").SubscriptionDetails;
}>;
