...
export declare function prepareStandardRestResource({ generateId }: {
    generateId: () => string;
}): <xResource>() => <xCreateParams, xUpdateParams>({ table, handleCreate, handleUpdate, }: {
    ...
    create(params: xCreateParams): Promise<import("stripe").Stripe.Response<xResource>>;
    update(id: string, params: xUpdateParams): Promise<import("stripe").Stripe.Response<xResource>>;
    retrieve(id: string): Promise<import("stripe").Stripe.Response<xResource>>;
