...
export declare function makeStorePolicies<xMeta>(options: StoreApiOptions): {
    guest: renraku.Policy<any, import("./types.js").StoreAuth>;
    connected: (meta: xMeta, headers: renraku.HttpHeaders) => Promise<{
        connectId: dbmage.Id;
    ...
    customer: (meta: xMeta, headers: renraku.HttpHeaders) => Promise<{
    ...
    merchant: (meta: xMeta, headers: renraku.HttpHeaders) => Promise<{
        helpers: {
