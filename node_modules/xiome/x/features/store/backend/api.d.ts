...
export declare function makeStoreApi<xMeta>(options: StoreApiOptions<xMeta>): {
    connect: renraku.Service<any, import("./policies/types.js").StoreAuth, {
        loadConnectDetails(): Promise<{
            connectDetails: import("../isomorphic/concepts.js").StripeConnectDetails;
            connectStatus: import("../isomorphic/concepts.js").StripeConnectStatus;
        }>;
        ...
        pause(): Promise<void>;
        resume(): Promise<void>;
        loadConnectStatus(): Promise<import("../isomorphic/concepts.js").StripeConnectStatus>;
    }>;
    billing: renraku.Service<unknown, {
        ...
        getDefaultPaymentMethod(): Promise<import("../isomorphic/concepts.js").PaymentMethod>;
    ...
    subscriptions: {
        listing: renraku.Service<unknown, {
            ...
            listPlans(): Promise<{
                ...
                planId: string;
                time: number;
                tiers: import("../isomorphic/concepts.js").SubscriptionTier[];
            }[]>;
        }>;
        planning: renraku.Service<unknown, {
            helpers: {
                createPlanAndTier({ planLabel, tier }: import("./services/subscriptions/types/drafts.js").SubscriptionPlanDraft): Promise<{
                ...
                createTierForPlan({ planId, label, pricing }: {
                    planId: string;
                    label: string;
                    pricing: import("./services/subscriptions/types/drafts.js").SubscriptionPricingDraft;
                }): Promise<{
                    tierId: import("dbmage").Id;
            ...
            addPlan(inputs: {
                planLabel: string;
                tier: import("./services/subscriptions/types/drafts.js").SubscriptionTierDraft;
        ...
        shopping: renraku.Service<unknown, {
            ...
            fetchDetailsAboutMySubscriptions(): Promise<import("../isomorphic/concepts.js").SubscriptionDetails[]>;
