...
export declare function queryStripeAboutSubscriptionPlans({ auth, tierRows }: {
    auth: StoreConnectedAuth;
    planRows: SubscriptionPlanRow[];
    tierRows: SubscriptionTierRow[];
}): Promise<{
    stripeProducts: (import("stripe").Stripe.Product & {
        lastResponse: {
            headers: {
                [key: string]: string;
            };
    ...
    stripePrices: (import("stripe").Stripe.Price & {
        lastResponse: {
            headers: {
                [key: string]: string;
            };
