        ...
        async "shows are updated when view is updated"() {
            ...
            const label2 = "view2";
            {
                const { contentModel } = await setup.for(roles.moderator)
                    .then(s => s.link());
                await contentModel.initializeForVideo(label);
                expect((_a = contentModel.getShow(label)) === null || _a === void 0 ? void 0 : _a.details).not.ok();
                await contentModel.setView({
                    label,
                    privileges: [viewPrivilege],
                    reference: contentModel.catalog[0],
                });
                expect((_b = contentModel.getShow(label)) === null || _b === void 0 ? void 0 : _b.details).ok();
                await contentModel.setView({
                    label: label2,
                    privileges: [viewPrivilege],
                    reference: contentModel.catalog[1],
                });
                expect((_c = contentModel.getShow(label2)) === null || _c === void 0 ? void 0 : _c.details).ok();
                await contentModel.deleteView(label);
                expect((_d = contentModel.getShow(label)) === null || _d === void 0 ? void 0 : _d.details).not.ok();
                await contentModel.setView({
                    label: label2,
                    privileges: [viewPrivilege],
