...
export const appTokenDraftValidators = Object.freeze({
    appId: validator(string(), length(64)),
    label: validator(string(), minLength(1), maxLength(50), notWhitespace()),
    origins: validator(each(string(), origin(), maxLength(1000)), minLength(1), maxLength(100)),
});
//# sourceMappingURL=app-token-draft-validators.js.map