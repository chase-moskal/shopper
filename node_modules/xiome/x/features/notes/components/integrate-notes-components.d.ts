...
export declare function integrateNotesComponents({ models: { notesModel } }: XiomeComponentOptions): {
    XiomeNotes: import("../../../types/mixin.js").Mixin<typeof XiomeNotes, import("../../../framework/component.js").WithShare<{
        notesModel: {
    ...
    XiomeNotesIndicator: import("../../../types/mixin.js").Mixin<typeof XiomeNotesIndicator, import("../../../framework/component.js").WithShare<{
        notesModel: {
            initialize: () => Promise<import("../types/notes-concepts.js").NotesStats>;
            state: {
                accessOp: import("../../../framework/ops.js").Op<import("../../auth/types/auth-tokens.js").AccessPayload>;
