...
export type DatabaseSchema = DatabaseSchemaUnisolated & DatabaseSchemaRequiresAppIsolation;
export type DatabaseRawTables = RemoveIndex<dbmage.SchemaToTables<DatabaseSchemaUnisolated> & SchemaToUnconstrainedTables<DatabaseSchemaRequiresAppIsolation>>;
export type DatabaseRaw = dbmage.DatabaseLike<DatabaseRawTables>;
export type DatabaseSafe = dbmage.Database<DatabaseSchema>;
export type DatabaseSelect<K extends keyof DatabaseRawTables> = dbmage.DatabaseLike<Pick<DatabaseRawTables, K>>;
