...
export declare function assimilateApi({ config, rando, databaseRaw, dacastSdk, stripeLiaison, sendLoginEmail, signToken, verifyToken, }: {
    ...
    auth: {
        ...
        users: {
            ...
            loginService: renraku.Service<AnonMeta, import("../../../features/auth/types/auth-metas.js").LoginAuth, {
            ...
            userService: renraku.Service<AnonMeta, import("../../../features/auth/types/auth-metas.js").LoginAuth, {
                getUser({ userId }: {
                    userId: string;
                }): Promise<{
                    userId: string;
        ...
        permissions: {
            permissionsService: renraku.Service<import("../../../features/auth/aspects/permissions/types/permissions-auth-and-metas.js").PermissionsMeta, {
                ...
                database: import("../types/database.js").DatabaseSafe;
    ...
    questions: {
        questionsReadingService: renraku.Service<AnonMeta, import("../../../features/questions/api/types/questions-metas-and-auths.js").QuestionsAnonAuth, {
