...
export type TokenSign = <Payload extends {}>(options: TokenSignOptions<Payload>) => Promise<string>;
export type TokenVerify = <Payload extends {}>(options: TokenVerifyOptions) => Promise<Payload>;
export type DecodedToken<Payload extends {}> = {
    header: TokenHeader;
    data: TokenData<Payload>;
};
export type TokenDecode = <Payload extends {}>(token: string) => DecodedToken<Payload>;
export type SignToken = <Payload extends {}>(options: {
    payload: Payload;
    lifespan: number;
}) => Promise<string>;
export type VerifyToken = <Payload extends {}>(token: string) => Promise<Payload>;
