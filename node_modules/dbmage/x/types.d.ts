...
export type Value = null | undefined | boolean | number | string | bigint | Id;
...
export type RowFromTable<xTable extends Table<Row>> = xTable extends Table<infer xRow> ? xRow : never;
...
export type Transaction<xTables extends Tables, xResult> = (action: Action<xTables, xResult>) => Promise<xResult>;
...
export type ConditionTree<xRow extends Row> = ConditionBranch<"and", xRow> | ConditionBranch<"or", xRow>;
...
export type Upsert<xRow extends Row> = Conditional<xRow> & {
    upsert: xRow;
};
export type Write<xRow extends Row> = Conditional<xRow> & {
    write: Partial<xRow>;
};
export type Whole<xRow extends Row> = Conditional<xRow> & {
    whole: xRow;
};
...
export type UnconstrainRow<xConstraint extends Row, xRow extends Row> = xConstraint & xRow;
export type ConstrainRow<xConstraint extends Row, xRow extends Row> = Omit<xRow, keyof xConstraint>;
export type UnconstrainTable<xConstraint extends Row, xTable extends Table<Row>> = xTable extends Table<infer xRow> ? Table<UnconstrainRow<xConstraint, xRow>> : never;
export type ConstrainTable<xConstraint extends Row, xTable extends Table<Row>> = xTable extends Table<infer xRow> ? Table<ConstrainRow<xConstraint, xRow>> : never;
...
export type UnconstrainSchema<xConstraint extends Row, xSchema extends Schema> = {
    [P in keyof xSchema]: xSchema[P] extends Row ? UnconstrainRow<xConstraint, xSchema[P]> : xSchema[P] extends Schema ? UnconstrainSchema<xConstraint, xSchema[P]> : never;
};
